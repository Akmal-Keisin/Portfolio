...
export const dummyArticles: PaginatedResource<Article> = {
  data: [
    ...
    {
      id: 2,
      title: "Composables That Don't Leak: Vue 3 Patterns I Actually Use",
      slug: "vue3-composables",
      excerpt:
        "Practical patterns for writing reusable, testable Vue 3 composables without the memory leak pitfalls.",
      author: "Akmal Keisin",
    ...
    {
      id: 3,
      title: "PostgreSQL Indexing Strategies for Growing Applications",
      slug: "postgres-indexing",
      excerpt:
        "When a single index isn't enough. Covering partial, composite, and covering indexes with real EXPLAIN ANALYZE output.",
      author: "Akmal Keisin",
    ...
    {
      id: 4,
      title: "Astro Islands + SSR: The Architecture Behind This Site",
      slug: "astro-islands-ssr",
      excerpt:
        "How I combined Astro's island architecture with SSR to get fast static pages with dynamic personalisation.",
      author: "Akmal Keisin",
    ...
    },
    {
      id: 6,
      title:
        "MySQL vs PostgreSQL: Choosing the Right Database for Your Laravel App",
      slug: "mysql-vs-postgresql-laravel",
      excerpt:
        "A pragmatic guide to choosing between MySQL and PostgreSQL for your Laravel project, based on real-world tradeoffs.",
      author: "Akmal Keisin",
      category: { id: 3, name: "Database" },
      tags: [
        { id: 11, name: "MySQL" },
